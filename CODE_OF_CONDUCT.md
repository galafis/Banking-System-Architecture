...
*   Ser respeitoso(a) com diferentes opiniões, pontos de vista e experiências
...
Instâncias de comportamento abusivo, assediador ou de outra forma inaceitável podem ser relatadas aos líderes da comunidade responsáveis pela aplicação em [INSERIR ENDEREÇO DE E-MAIL].
Todos os relatórios serão revisados e investigados prontamente e de forma justa.
Todas as lideranças da comunidade são obrigadas a respeitar a privacidade e a segurança do(a) relator(a) de qualquer incidente.
